...
2. 拉取或读取源仓库：`https://github.com/kevin0201z/codex_with_claude.git`。
...
On delegation failure, follow the failure contract in that file — report the failure from the resolved delegate artifacts and do NOT fall back to the default Codex subagent.
<!-- END CODEX_WITH_CC -->
```
